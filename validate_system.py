...
def validate_fits_processing():
    ...
    for file_path in test_files:
        ...
        if result:
            print(f"✓ Successfully loaded FITS file")
...
def validate_cv_prefiltering(test_files):
    ...
    for file_path in test_files:
        ...
        if result:
            ...
            print(f"  - Cloud coverage: {analysis['clouds']['cloud_coverage_percent']:.3f}%")
            print(f"  - Saturation ratio: {analysis['saturation']['saturation_percent']:.3f}%")
...
def validate_ml_model():
    ...
    try:
        ...
        print(f"✓ Data transforms created")
...
def validate_integration():
    ...
    for file_path in test_files:
        ...
        try:
            ...
            result = {
                ...
                'has_artifacts': cv_analysis['streaks']['has_streaks'] or cv_analysis['clouds']['cloud_coverage_percent'] > 10.0,
    ...
    if successful > 0:
        avg_quality = np.mean([r['quality_score'] for r in results if r.get('loaded', False)])
